 ...
 */
// define("WECHAT_URL", 'http://cbl.tunnel.qydev.com/');
define("WECHAT_URL", 'http://test4.angkebrand.com/');
define('WECHAT_TOKEN', 'jyy');
// define('ENCODING_AES_KEY', "MqAuKoex6FyT5No0OcpRyCicThGs0P1vz4mJ2gwvvkF");

/*
 * 开发者配置
 */
define("WECHAT_APPID", 'wx19828ddd2c84b86c');
...
////引入微信请求处理类
include_once 'core/wechatrequest.class.php';
////引入微信被动响应处理类
include_once 'core/responsepassive.class.php';
////引入微信access_token类
include 'core/accesstoken.class.php';
//
////-----如果是认证服务号，需要引入以下类--------------
////引入微信权限管理类
