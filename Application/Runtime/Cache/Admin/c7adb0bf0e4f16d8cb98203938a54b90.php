    ...
    <section>
      <table class="table">
        ...
        <?php if(is_array($arr)): foreach($arr as $key=>$v): ?><tr>
          ...
          <td>
          <?php if($v["order_status"] == 4): ?><a href="<?php echo U('Home/Order/commentDetail');?>?room_id=<?php echo ($v["room_id"]); ?>&user_id=<?php echo ($v["user_id"]); ?>" class="inner_btn1">查看评价</a><?php endif; ?>
          </td>
