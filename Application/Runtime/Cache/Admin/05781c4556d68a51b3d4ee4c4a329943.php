		...
		<section>
			...
			<table class="table">
				...
				<?php if(is_array($arr)): foreach($arr as $key=>$v): ?><tr>
					...
					<td>
					<?php if(!empty($v["service_image"])): ?><img src="/sy/Public/Uploads/<?php echo ($v["service_image"]); ?>" height="40"><?php endif; ?>
					</td>
					...
					<td>
					<a href="<?php echo U('Admin/Goods/serviceModifyPage');?>?service_id=<?php echo ($v["service_id"]); ?>" class="inner_btn">修改</a>
					<a href="<?php echo U('Admin/Goods/serviceDelete');?>?service_id=<?php echo ($v["service_id"]); ?>&service_image=<?php echo ($v["service_image"]); ?>" class="inner_btn2">删除</a>
					</td>
