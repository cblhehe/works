...
<section class="rt_wrap content mCustomScrollbar">
 ...
 <section>
  <ul class="admin_tab">
    ...
    <li><a  href="<?php echo U('Admin/Order/waitFinish');?>">待完成</a></li>
    <li><a href="<?php echo U('Admin/Order/serviceCompleted');?>" >已完成</a></li>
    <li><a class="active" >已取消</a></li>
  </ul>
  <!--tabCont1-->
    ...
    <section>
      <table class="table">
        ...
        <?php if(is_array($arr)): foreach($arr as $key=>$v): ?><tr>
          ...
          <td>
         <a href="<?php echo U('Admin/Order/orderDelete');?>?order_id=<?php echo ($v["order_id"]); ?>" class="inner_btn2" >删除</a>
          </td>
